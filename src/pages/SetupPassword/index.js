        ...
        if (password === confirmPassword) {
          try {
            ...
            if (res.successful) {
              ...
              localStorage.setItem("set_up_profile", "true");
              ...
              dispatch(
                masterActions.updateNotificationModal({
                  open: true,
                  type: "success",
                  bodyText: "Your password has been set!",
                        ...
                        <CCard className="p-4">
                          <CCardBody>
                            <CForm onSubmit={(e) => handleChangePass(e)}>
                              <h1 className="mb-2">Setup Password</h1>
                              <small>Please setup your password first.</small>
                              <div className="mt-3">
                                <div className="mb-3">
                                  <CLabel>
                                    New Password{" "}
